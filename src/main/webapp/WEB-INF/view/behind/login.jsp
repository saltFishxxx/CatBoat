...
<div class="login-box">
    <div class="login-logo">
        ...
        <a href="all-admin-index.html"><b>猫舟</b>后台管理系统</a>
    ...
    <div class="login-box-body">
        ...
        <form action="${pageContext.request.contextPath}/admin/login.do" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="账号" name="adminName">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label><input type="checkbox" name="flag" value="remember"> 记住 下次自动登录</label>
                    </div>
                </div>
                <!-- /.col -->
                <div class="col-xs-4">
